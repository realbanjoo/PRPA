...
bool Geometric_Spanner::t_path_exist(const std::vector<Edge> span_edges, Edge e,
    const long double t)
{
...
bool Geometric_Spanner::OPT_t_path_exist(const std::vector<Edge> span_edges, Edge e,
    const long double t)
{
  // Use Dijkstra algorithm
  std::vector<Node*> p;
...
void Geometric_Spanner::greedy_Spanner (const long double t)
{
...
void Geometric_Spanner::OPT_greedy_Spanner (const long double t)
{
  std::vector<Edge> all_edges;
  span.clear();
  // Computes all possible edges of the complete graph
